...
function Enviado() {
  return (
    <div className="flex flex-wrap justify-center items-center h-[87vh] bg-red-600">
      <div className="flex flex-wrap justify-center w-4/5 bg-gray-500">
        <div className="w-full flex justify-center">
          <img src={logo} alt="logo" className="w-80" />
        </div>
        <div className=" flex flex-col justify-center items-center w-6/12 bg-amber-400 text-center">
